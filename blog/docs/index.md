---
title: Documentation | FORJA2.0
description: Explains how to use FORJA2.0, how to write weightlifting programs, goes over Liftoscript syntax.
og_title: Documentation | FORJA2.0
canonical: https://www.liftosaur.com/doc/
og_description: Explains how to use FORJA2.0, how to write weightlifting programs, goes over Liftoscript syntax.
layout: blogpost
---
...
FORJA2.0 is an app that combines both weightlifting programming part (that people sometimes use Google Sheets for) and workouts tracking part. I.e. it consists of 2 steps:
...
Any built-in program is built using existing FORJA2.0 features, so those programs are completely customizable - you can change every bit of them.

Instead of clicking around to add exercises like in other apps, FORJA2.0 takes a different approach - you create the programs by typing your exercises, sets, reps, etc in a text field, using special syntax called **Liftoscript**. There's some learning curve because of that, but the syntax is very simple and autocomplete helps, and once you get familiar with it - you can create and edit the programs very quickly and efficiently.
...
There, you can unleash the full power of the scripting in FORJA2.0. You can directly change weights, reps, sets, timers, RPE, etc using `if/else`s, state variables, math and boolean logic.
